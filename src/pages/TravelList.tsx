    ...
    <div className="animate-fade-in-up pb-20">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-dashed border-gray-300 dark:border-gray-700">
          ...
          <button onClick={handleOpenCreate} className="text-amber-600 font-medium hover:underline">첫 번째 여행을 만들어보세요!</button>
        </div>
      ) : (
          ...
          {travels.map((travel) => {
            return (
              <div key={travel.id} className="relative">
                ...
                >
                  <div className="pr-8">
                    <h3 className="text-xl font-semibold mb-3 group-hover:text-amber-600 dark:group-hover:text-amber-500 transition-colors line-clamp-1">
                      {travel.name}
                    </h3>
                  </div>
